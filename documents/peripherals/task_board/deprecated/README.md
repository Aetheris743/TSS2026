## DEPRECATED: Task Board Photos

### Disclaimer:
Please note these pictures are temporary and will be replaced with a full suite of pictures ideal for computer vision training. These pictures serve to give participants an idea of what the task board will look like and give them the ability to cross reference procedures with what will be performed during Test Week. As of writing, we are waiting on final components to perform finalized assembly and taking full pictures. Thank you for your patience.
